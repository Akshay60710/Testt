...
module.exports = async (client, message) => {
    ...
    if (cmd.length === 0){
      ...
      if(matchedPrefix.includes(client.user.id)){
        ...
        .setAuthor(`Getting Stared | Rex Music`, client.user.displayAvatarURL({dynamic: true}), config.links.opmusicinv)
        .setDescription(`You can play music by joining a voice channel and typing \`${prefix}play\`.
Type \`${prefix}help\` To Get All Commands Help Menu.`)
        .addField(`Links`, `[Invite Me](${config.links.opmusicinv}) | [Support Server](${config.links.server})`)
  		  .setColor("#00fefc")
        .setFooter(`Developed By *₊⋆𓆩𝐍ot𝐘our𝐒ʜɪᴠᴀᴍ𓆪⃟🍷#3979 & Oᴍ#8161`)
